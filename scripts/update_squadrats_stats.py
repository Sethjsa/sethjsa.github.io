...
an endpoint, so this script reimplements that from scratch:
  ...
  4. Render the largest cluster as a PNG, overlaid on real OpenStreetMap
     raster tiles for geographic context.
...
def main():
    ...
    print(f"Wrote {DATA_FILE} and {MAP_FILE}", file=sys.stderr)
